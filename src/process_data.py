CPDB_PATHWAYS_FILE = './data/raw_data/CPDB_pathways_genes.tsv'
ONCOKB_FILE = './data/raw_data/onkoKB.tsv'
NCG_FILE = './data/raw_dataNCG_cancerdrivers_annotation_supporting_evidence.tsv'
NCG_CANDIDATE_HEALTHY_FILE = './data/raw_data/NCG_candidate_and_remaining_healthy_drivers.txt'
NCG_CANONICAL_HEALTHY_FILE = './data/raw_data/NCG_cancer_and_healthy_drivers.txt'
COSMIC_FILE = './data/raw_data/Cosmic_11_2025.tsv'
OMIM_FILE = './data/raw_data/All_Diseases_OMIM.txt'
HGNC_FILE = './data/raw_data/hgnc-symbol-check_combined.csv'
BUSHMAN_FILE = './dat/raw_data/Bushman_group_allOnco.tsv'
UNION_FEATURES_FILE = './data/processed/UNION_features.tsv'
